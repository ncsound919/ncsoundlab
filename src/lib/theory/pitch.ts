...
// Aliases matching the Session Musician engine's naming (SEMITONE_NAMES /
// NOTE_MAP) so ports of engine modules keep their original references.
export const SEMITONE_NAMES = NOTE_NAMES_SHARP;
